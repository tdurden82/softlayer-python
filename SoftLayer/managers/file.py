...
class FileStorageManager(utils.IdentifierMixin, object):
    ...
    def __init__(self, client):
        ...
        self.file_svc = self.client['Network_Storage']
    ...
    def get_file_volume_details(self, volume_id, **kwargs):
        ...
        if 'mask' not in kwargs:
            ...
            kwargs['mask'] = "mask[%s]" % ','.join(items)
        return self.file_svc.getObject(id=volume_id, **kwargs)
    ...
    def order_file_volume(self, storage_type, location, size, iops=None,
                          tier_level=None, **kwargs):
                ...
                for category in price['categories']:
                    if price['locationGroupId'] == '' \
                            and (category[
                                 ...
                                 or category['categoryCode'] == 'storage_file'
                                 or (category[
                                         'categoryCode'] == 'performance_storage_space'
                                     and price[
